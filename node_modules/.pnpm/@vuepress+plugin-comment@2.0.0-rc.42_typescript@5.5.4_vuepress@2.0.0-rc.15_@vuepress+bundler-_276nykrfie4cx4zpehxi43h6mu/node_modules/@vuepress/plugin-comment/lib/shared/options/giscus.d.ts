...
export type GiscusMapping = 'number' | 'og:title' | 'pathname' | 'specific' | 'title' | 'url';
export type GiscusInputPosition = 'bottom' | 'top';
export type GiscusTheme = 'dark_dimmed' | 'dark_high_contrast' | 'dark_protanopia' | 'dark' | 'light_high_contrast' | 'light_protanopia' | 'light' | 'preferred_color_scheme' | 'transparent_dark' | `https://${string}`;
